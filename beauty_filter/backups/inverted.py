...
class BeautyFilter:
    ...
    def get_lip_landmarks(self) -> List[int]:
        ...
        try:
            ...
            upper_lip = [10, 338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 400, 390, 435, 273, 335, 303, 314, 409, 304, 302, 11, 61, 84, 18, 91, 146, 62, 78, 87, 88, 95, 76, 17, 314, 405, 320, 307, 375, 321, 308, 324, 318, 402]
            lower_lip = [0, 37, 39, 40, 185, 57, 109, 108, 67, 103, 54, 65, 93, 13, 78, 95, 88, 178, 87, 14, 317, 402, 318, 324, 308, 415, 310, 311, 312, 13, 82, 81, 80, 78, 306, 40, 39, 37, 0, 267, 269, 270, 409, 291, 322, 321, 311, 310, 312, 13, 14, 17, 314, 317, 402]
                ...
                try:
                    ...
                    if current_dress:
                        ...
                        if pose_metrics:
                            ...
                            target_w = max(100, min(self.config.WIDTH_FACTOR * pose_metrics['shoulder_width'], w))
                            target_h = max(150, min(self.config.HEIGHT_FACTOR * pose_metrics['shoulder_width'] * 1.5, h)) # Approximate torso height from shoulder width
                            offset_y = self.config.VERTICAL_OFFSET_FACTOR * target_h

                            # Keep dress visible if torso is cut off
                            dress_center = (
                                pose_metrics['shoulder_mid'][0],
                                min(int(pose_metrics['shoulder_mid'][1] + offset_y), h - target_h // 2)
                            )
